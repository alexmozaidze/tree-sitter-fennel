...
enum {
  ts_external_token_hashfn = 0,
  ts_external_token_quote = 1,
  ts_external_token_quasiquote = 2,
  ts_external_token_unquote = 3,
};

static const TSSymbol ts_external_scanner_symbol_map[EXTERNAL_TOKEN_COUNT] = {
  [ts_external_token_hashfn] = sym_hashfn,
  [ts_external_token_quote] = sym_quote,
  [ts_external_token_quasiquote] = sym_quasiquote,
  [ts_external_token_unquote] = sym_unquote,
};

static const bool ts_external_scanner_states[2][EXTERNAL_TOKEN_COUNT] = {
  [1] = {
    [ts_external_token_hashfn] = true,
    [ts_external_token_quote] = true,
    [ts_external_token_quasiquote] = true,
    [ts_external_token_unquote] = true,
  },
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_hashfn] = ACTIONS(29),
    [sym_quote] = ACTIONS(29),
    [sym_quasiquote] = ACTIONS(29),
    [sym_unquote] = ACTIONS(29),
  },
  [2] = {
    [sym__sexp] = STATE(10),
    ...
    [sym_hashfn] = ACTIONS(53),
    [sym_quote] = ACTIONS(53),
    [sym_quasiquote] = ACTIONS(53),
    [sym_unquote] = ACTIONS(53),
  },
  [3] = {
    [sym__sexp] = STATE(46),
    ...
    [sym_hashfn] = ACTIONS(87),
    [sym_quote] = ACTIONS(87),
    [sym_quasiquote] = ACTIONS(87),
    [sym_unquote] = ACTIONS(87),
  },
  [4] = {
    [sym__sexp] = STATE(20),
  ...
  [9] = {
    ...
    [sym_hashfn] = ACTIONS(136),
    [sym_quote] = ACTIONS(136),
    [sym_quasiquote] = ACTIONS(136),
    [sym_unquote] = ACTIONS(136),
  },
  [10] = {
    [sym__sexp] = STATE(46),
    [sym__special_override_symbols] = STATE(46),
  ...
  [15] = {
    ...
    [sym_hashfn] = ACTIONS(183),
    [sym_quote] = ACTIONS(183),
    [sym_quasiquote] = ACTIONS(183),
  ...
  [23] = {
    ...
    [sym_hashfn] = ACTIONS(206),
    [sym_quote] = ACTIONS(206),
    [sym_quasiquote] = ACTIONS(206),
    [sym_unquote] = ACTIONS(206),
  },
  [24] = {
    [aux_sym_multi_symbol_repeat1] = STATE(23),
    ...
    [sym_hashfn] = ACTIONS(213),
    [sym_quote] = ACTIONS(213),
    [sym_quasiquote] = ACTIONS(213),
    [sym_unquote] = ACTIONS(213),
  },
  [25] = {
    ...
    [sym_hashfn] = ACTIONS(219),
    [sym_quote] = ACTIONS(219),
    [sym_quasiquote] = ACTIONS(219),
    [sym_unquote] = ACTIONS(219),
  },
  [26] = {
    ...
    [sym_hashfn] = ACTIONS(225),
    [sym_quote] = ACTIONS(225),
    [sym_quasiquote] = ACTIONS(225),
    [sym_unquote] = ACTIONS(225),
  },
};
