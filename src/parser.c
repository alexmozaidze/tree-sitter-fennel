  ...
  switch (state) {
    ...
    case 4:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == '\r' ||
          lookahead == ' ') ADVANCE(24);
      if (!sym_symbol_character_set_1(lookahead)) ADVANCE(109);
      END_STATE();
    case 5:
    ...
    case 56:
      ...
      if (!aux_sym__colon_string_token1_character_set_2(lookahead)) ADVANCE(73);
      END_STATE();
    case 57:
      ACCEPT_TOKEN(aux_sym__colon_string_token1);
    ...
    case 90:
      ...
      if (!sym_symbol_character_set_2(lookahead)) ADVANCE(109);
      END_STATE();
    case 91:
      ACCEPT_TOKEN(sym_number);
      if (lookahead == '.') ADVANCE(93);
    ...
    case 97:
      ...
      if (!sym_symbol_character_set_3(lookahead)) ADVANCE(109);
      END_STATE();
    case 98:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9') ||
    ...
    case 105:
      ...
      if (!sym_symbol_character_set_4(lookahead)) ADVANCE(109);
      END_STATE();
    case 106:
      ACCEPT_TOKEN(sym_symbol);
      if (lookahead == '+' ||
